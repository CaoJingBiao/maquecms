...
CREATE TABLE `cms_admin_action` (
  ...
  `px` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '排序，数越大越靠前',
  `pid` int(5) unsigned NOT NULL DEFAULT '0',
  `name` varchar(30) NOT NULL DEFAULT '',
  `controller` varchar(50) NOT NULL DEFAULT '' COMMENT '控制器',
  `action` varchar(50) NOT NULL DEFAULT '' COMMENT '节点',
  `value` varchar(50) NOT NULL DEFAULT '',
  `type` varchar(15) NOT NULL DEFAULT '' COMMENT '类型:控制器，操作',
  `status` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '状态，启用禁用',
  `addtime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `uptime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`actionid`)
) ENGINE=InnoDB AUTO_INCREMENT=121 DEFAULT CHARSET=utf8 COMMENT='操作列表';
...
CREATE TABLE `cms_admin_list` (
  ...
  `cas` int(1) unsigned NOT NULL DEFAULT '0' COMMENT 'cas 登录',
  `addtime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '添加时间',
  `uptime` varchar(50) NOT NULL DEFAULT '' COMMENT '更新时间',
  `logintime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '上次登录时间',
...
CREATE TABLE `cms_admin_log` (
  ...
  `name` varchar(50) NOT NULL DEFAULT '' COMMENT '管理员名字',
  `content` text NOT NULL COMMENT '操作内容',
  `ip` varchar(30) NOT NULL DEFAULT '' COMMENT 'ip地址',
  `addtime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '操作时间',
  PRIMARY KEY (`logid`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='管理员操作日志';
...
CREATE TABLE `cms_admin_role` (
  ...
  `name` varchar(30) NOT NULL DEFAULT '',
  `px` int(5) unsigned NOT NULL DEFAULT '0' COMMENT '排序',
  ...
  `uptime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`roleid`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='角色列表';
...
CREATE TABLE `cms_banner_list` (
  ...
  `link` varchar(150) NOT NULL DEFAULT '' COMMENT '链接',
  `px` int(2) unsigned NOT NULL DEFAULT '0',
  `status` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '状态',
  `addtime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '添加时间',
  `uptime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '修改时间',
  PRIMARY KEY (`bannerid`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='banner列表';
...
CREATE TABLE `cms_comment_list` (
  ...
  `newsid` int(5) unsigned NOT NULL DEFAULT '0' COMMENT '新闻id',
  `newstitle` varchar(150) NOT NULL DEFAULT '' COMMENT '新闻标题',
  `newsurl` varchar(150) NOT NULL DEFAULT '',
  `floor` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '回复楼层id',
  `pid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '回复的id',
  `touser` varchar(50) NOT NULL DEFAULT '' COMMENT '回复给哪个用户',
  `touserid` int(11) unsigned NOT NULL DEFAULT '0',
  `userid` int(8) unsigned NOT NULL DEFAULT '0',
  `nickname` varchar(50) NOT NULL DEFAULT '' COMMENT '昵称',
  `avatar` varchar(150) NOT NULL DEFAULT '' COMMENT '头像',
  `content` varchar(255) NOT NULL DEFAULT '' COMMENT '内容',
  `zan` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '点赞数量',
  `status` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '状态',
  `hot` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '推荐',
  `top` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '置顶',
  `addtime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '评论时间',
  `uptime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='评论列表';
...
CREATE TABLE `cms_link_list` (
  ...
  `uptime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '修改时间',
  PRIMARY KEY (`linkid`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='banner列表';
...
CREATE TABLE `cms_msg_list` (
  ...
  `add` varchar(150) NOT NULL DEFAULT '' COMMENT '地址',
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='留言';
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='模型列表';
...
CREATE TABLE `cms_news_cate` (
  ...
  `catepx` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '排序',
  `catename` varchar(100) NOT NULL DEFAULT '' COMMENT '分类名称',
  `catethumb` varchar(150) NOT NULL DEFAULT '' COMMENT '缩略图',
  `other` varchar(30) NOT NULL DEFAULT '' COMMENT '其他',
  `url` varchar(150) NOT NULL DEFAULT '' COMMENT '跳转连接',
  `modelid` int(5) unsigned NOT NULL DEFAULT '0' COMMENT '模型id',
  ...
  `isnav` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '导航栏是否可见',
  `status` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '状态，0 ，1',
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='分类';
...
CREATE TABLE `cms_news_list` (
  ...
  `cateid` int(3) unsigned NOT NULL DEFAULT '0' COMMENT '分类id',
  ...
  `photos` text NOT NULL COMMENT '图集',
  `files` text NOT NULL COMMENT '文件地址',
  ...
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '状态，1正常，0不正藏,-1 草稿',
  `authorid` int(5) unsigned NOT NULL DEFAULT '0' COMMENT '作者id',
  `authorname` varchar(50) NOT NULL DEFAULT '' COMMENT '作者名称',
  `authorpic` varchar(150) NOT NULL DEFAULT '' COMMENT '作者头像',
  `template` varchar(50) NOT NULL DEFAULT '' COMMENT '模板名称',
  `url` varchar(150) NOT NULL DEFAULT '' COMMENT '跳转链接',
  `iscomment` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否允许评论，1允许，0不允许',
  `addtime` timestamp NULL DEFAULT NULL COMMENT '添加时间',
  `uptime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '更新时间',
  `pushtime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '发布时间',
  PRIMARY KEY (`newsid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='新闻列表';
...
CREATE TABLE `cms_news_model` (
  ...
  `authorid` int(8) unsigned NOT NULL DEFAULT '0' COMMENT '作者id',
  `iscomment` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '是否允许评论',
  `status` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '状态',
  `addtime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '添加时间',
  `uptime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '修改时间',
  PRIMARY KEY (`modelid`)
...
CREATE TABLE `cms_user_list` (
  ...
  `sign` varchar(150) NOT NULL DEFAULT '' COMMENT '签名',
  `status` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '状态',
  `addtime` timestamp NULL DEFAULT NULL COMMENT '添加时间',
  `uptime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '修改时间',
  `logintime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '上次登录时间',
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='用户列表';
...
CREATE TABLE `cms_admin_menu` (
  ...
  `iconv` varchar(150) NOT NULL DEFAULT '' COMMENT '图标',
  `name` varchar(50) NOT NULL DEFAULT '' COMMENT '菜单名称',
  `type` varchar(20) NOT NULL DEFAULT '' COMMENT '菜单类型',
  `data` varchar(255) NOT NULL DEFAULT '' COMMENT '参数',
  `status` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '状态',
  `addtime` timestamp NULL DEFAULT '0000-00-00 00:00:00' COMMENT '添加时间',
  `uptime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '修改时间',
  PRIMARY KEY (`menuid`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='管理员菜单';
